...
export default function Home() {
  return (
    ...
    <div className='flex-col w-64 bg-white border-red-500 border-2 p-8'>

      <div className="relative  wflex-1 border-red-500 border-2 p-8 rounded-2xl overflow-hidden">
          <Image
